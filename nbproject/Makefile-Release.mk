...
${OBJECTDIR}/FahrkartenautomatMain.o: FahrkartenautomatMain.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FahrkartenautomatMain.o FahrkartenautomatMain.cpp

${OBJECTDIR}/Geldeinheit.o: Geldeinheit.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geldeinheit.o Geldeinheit.cpp

${OBJECTDIR}/GeldeinheitListe.o: GeldeinheitListe.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GeldeinheitListe.o GeldeinheitListe.cpp

${OBJECTDIR}/MeineEingabe.o: MeineEingabe.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MeineEingabe.o MeineEingabe.cpp

${OBJECTDIR}/Produkt.o: Produkt.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Produkt.o Produkt.cpp

${OBJECTDIR}/ProduktListe.o: ProduktListe.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProduktListe.o ProduktListe.cpp
